...
module.exports = { 
    ...
    run: async (client, message, args, user, language, prefix) => {
        ...
        const embeded = new MessageEmbed()
            ...
            .addField(`${client.i18n.get(language, "music", "np_likes")}`, `${queue.songs[0].likes}`, true)
            .addField(`${client.i18n.get(language, "music", "np_dislikes")}`, `${queue.songs[0].dislikes}`, true)
